...
- **The five design pillars** documented — the Living Wiki, One Program Per Agent, Generate-then-Verify, the Council, and Forkable-by-design — now explained in the README and the website.
- **Comic-book website** — a fully revamped project site under `site/`, including a home page, the council roster, and the field manual / interactive comic guide served at `/guide`.
