...
becky/
  ...
  modes/             Greenfield and brownfield workflow definitions
...
5. **Two modes, one system.** Greenfield (discovery-first) and brownfield (archaeology-first) share the same rules, agents, and wiki.
